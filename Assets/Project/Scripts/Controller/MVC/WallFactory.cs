...
public class WallFactory : MonoBehaviour
{
    ...
    public Dictionary<(int x, int y), Dictionary<(DestroyWallDirection, ColorType), int>> wallCoorInfoDic;
    public Material[] WallMaterials { get { return wallMaterials; } }

    public async Task CreateCustomWalls(BoardController boardController)
    {
        ...
        var boardParent = boardController.GetBoardTransform;
